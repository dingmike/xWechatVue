<template>
  <div class="preview-page" :style="{height: pageSize + 'px'}" v-if="loaded">
          ...
          <div class="cl-m-body">
            ...
            <template v-for="(question, questionindex) in task.questions">
              <template v-if="question.type==='photo'">
                ...
                <router-link :to="'/agency_tour/course_answer/' + id + '/'+ index + '/' + questionindex" v-if="course.status>'8'">
                    <p>
      ...
      <div class="cl-m-body">
        ...
        <template v-for="(question, index) in material.homework.question">
          <template v-if="question.type==='photo'">
            ...
            <router-link :to="'/agency_tour/homework_answer/' + id + '/0/' + index" v-if="course.status>8">
                <p>
    ...
    <div class="cl-module img-item" v-if="course.status>8 && course.coursePics && course.coursePics.length !=0">
      ...
      <div class="cl-m-body">
        <img :src="countSmallUrl(item, 'x1')" alt="" v-for="item in course.coursePics" @click="previewImage(item, course.coursePics)">
      </div>
    </div>
  </div>
</template>
